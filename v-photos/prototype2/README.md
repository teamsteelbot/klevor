...
Una parte fundamental para nuestro robot es su sistema de cruce. Es basado en un
...
**ICR** (Centro Instantáneo de Rotación): Es el punto alrededor del cual el eje
delantero está girando.

**R**: Es el radio del giro del vehículo, medido desde el ICR hasta el centro
del eje trasero.

**L**: Es la distancia entre el eje delantero y el eje trasero de Klevor, o la
...
Esto ilustra más la geometría de la dirección que permite que las ruedas
...
boquilla del motor y que se conecta a 2 piñones más junto al engranaje principal
del eje transmisor, reduciendo así la velocidad del motor, pero añadiendo más
fuerza al mismo.
...
que ya no están, esta primera capa también está diseñada con esa forma debido a
las piezas de kits que no son modificables, como lo son los diferenciales, los
muñones de dirección y el eje transmisor. Así hicimos un espacio a medida para
...
Decidimos colocarlo al revés para que evitar que tenga lecturas erróneas debido
...
diseño, la fabricación, la ingeniería y el diseño de PCB, todo esto asistido por
computadora, lo que hace todo mucho más cómodo.
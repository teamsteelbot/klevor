# Librerías de Circuit Python {:#circuit-python-libraries}
...
Esta librería cumple el mismo propósito en Klevor, siendo utilizada por la [Raspberry Pi Pico 2WH](../../electronic/components/current.es.md#raspberry-pi-pico-2-wh) quien se comunica con el [ESC](../../electronic/components/current.es.md#injora-mb100-20a-mini-esc) para controlar el [motor](../../electronic/components/current.es.md#injora-180-motor-48t) y el [servomotor](../../electronic/components/current.es.md#injora-7kg-2065-micro-servo) y así poder manejar a Klevor.
...
En el caso de Klevor, utilizamos esta librería en conjunto con el [giroscopio](../../electronic/components/current.es.md#gyroscope-gy-bno085) para que, cuando Klevor esté en medio de un cruce, poder determinar con exactitud cuando ha girado 90° y así, saber que ya terminó de cruzar y que debe de avanzar recto.

...
A futuro queremos colocar un [RPLidar C1](../../electronic/components/current.md#rplidar-c1), un componente que mejorará el funcionamiento del robot, tanto en su tiempo de respuesta como en su ángulo de visión.

...
alt="Vista delantera del prototipo 3" width="600">
					<br>
					<i>Vista delantera del prototipo 3</i>
				</p>
			</td>
			<td>
				<p align="center">
					<img src="../../assets/images/github/v-photos/prototype3/prototype3-back-view.png"
alt="Vista trasera del prototipo 3" width="600">
					<br>
					<i>Vista trasera del prototipo 3</i>
				</p>
			</td>
		</tr>
		<tr>
...
alt="Vista derecha del prototipo 3" width="600">
					<br>
					<i>Vista derecha del prototipo 3</i>
				</p>
			</td>
			<td>
				<p align="center">
					<img src="../../assets/images/github/v-photos/prototype3/prototype3-left-view.png"
alt="Vista izquierda del prototipo 3" width="600">
					<br>
					<i>Vista izquierda del prototipo 3</i>
				</p>
			</td>
		</tr>
		<tr>
...
alt="Vista superior del prototipo 3" width="600">
					<br>
					<i>Vista superior del prototipo 3</i>
				</p>
			</td>
			<td>
				<p align="center">
					<img src="../../assets/images/github/v-photos/prototype3/prototype3-bottom-view.png"
alt="Vista inferior del prototipo 3" width="600">
					<br>
...
A este primer nivel del robot únicamente se le hicieron modificaciones en cuanto a pesaje. Lo que significa que su sistema motriz continúa exactamente igual al del prototipo anterior ([Prototipo 2](prototype2.es.md#primera-capa)).

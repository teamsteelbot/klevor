...
<!-- github-only-start -->
<p align="center">
	<img src="../../../assets/images/github/models/plans/common/current/rpm-reduction-system-mounting.png" alt="Base del sistema reductor de RPM" 
	width="600">
	<br>
...
Todo nuestro sistema motriz está basado en el uso de dos diferenciales, los cuales juegan un papel fundamental al permitir que las cuatro ruedas tengan tracción. Gracias a esta configuración, se logra una distribución perfecta de la fuerza.

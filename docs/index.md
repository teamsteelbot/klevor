...
4. **Programación**
    ...
    2. Librerías
        1. [Python](programming/libraries/python.md#python)
            1. [PyTorch](programming/libraries/python.md#pytorch)
            2. [Ultralytics YOLO](programming/libraries/python.md#ultralytics-yolo)
            3. [OpenCV](programming/libraries/python.md#opencv)
            4. [NumPy](programming/libraries/python.md#numpy)

...
require (
	github.com/ralvarezdev/tinygo-bno08x v0.5.4
	github.com/ralvarezdev/tinygo-escmotor v0.0.2
	github.com/ralvarezdev/tinygo-logger v0.0.4
	github.com/ralvarezdev/tinygo-pullup v0.0.1
	github.com/ralvarezdev/tinygo-servo v0.0.2

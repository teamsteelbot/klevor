...
dar una vuelta, esto está mejor definido en el [Diagrama de Flujo](../../../../schemes/prototype2/open-challenge-flowchart.png) (click aquí para poder hacer zoom).
...
- Tras completar los 12 giros, Klevor simplemente avanza hasta que detecte que la distancia al frente sea de alrededor de 1.25m, tras esto simplemente para.
...
if __name__ == "__main__":
    ...
    photographer_process = Process(
        ...
        args=(arg_debug, images_queue, capture_image_event, start_event,
    ...
    try:
        ...
        print("KeyboardInterrupt received. Stopping camera and writer processes...")
        logger.warning("KeyboardInterrupt received. Stopping camera and writer processes.")

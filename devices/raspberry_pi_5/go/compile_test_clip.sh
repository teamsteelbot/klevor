...
SOURCE_DIR="${SCRIPT_DIR}/cmd/tests/clip"
OUTPUT_DIR="${SCRIPT_DIR}/output/bin/tests"
...
echo "Compiling Go test program for CLIP..."

go build -o "${OUTPUT_DIR}/clip" "${SOURCE_DIR}"

...
class Hailo:
    ...
    def __init__(self, model_name: str, hef_file_path: LiteralString | str | bytes, labels_path: LiteralString | str | bytes, 
                 class_colors: tuple[tuple[int,int,int]], multi_threading: bool = True, multiprocessing: bool = False, 
                 image_processing_queue: ImageProcessingQueue = None, logger: LoggerABC = None,
        ...
        Args:
            ...
            hef_file_path (LiteralString|str|bytes): Path to the HEF file.
            labels_path (LiteralString|str|bytes): Path to the labels file.
        ...
        self.__logger = SubLogger(self.LOG_TAG)

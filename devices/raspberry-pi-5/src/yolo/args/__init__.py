...
class Args(A):
    ...
    def add_yolo_input_model_pt_argument(cls, parser: ArgumentParser) -> None:
        ...
        """
        cls._add_non_boolean_argument(parser, Flag.INPUT_MODEL_PT, type=str,
                                      required=True,
    ...
    def add_yolo_output_model_argument(cls, parser: ArgumentParser) -> None:
        ...
        Args:
            parser (ArgumentParser): The argument parser to which the argument will be added.
        """
        cls._add_non_boolean_argument(parser, Flag.OUTPUT_MODEL, type=str,
                                      required=True, help='YOLO output model',
                                      choices=MODELS_NAME)

    @classmethod
    def add_yolo_format_argument(cls, parser: ArgumentParser,
        ...
        """
        cls._add_non_boolean_argument(parser, Flag.FORMAT, type=str,
                                      required=required, help='YOLO format',
                                      choices=FORMATS, default=FORMAT_PT)

    @classmethod
    def add_yolo_quantized_argument(cls, parser: ArgumentParser,
    ...
    @classmethod
    def add_yolo_retraining_argument(cls, parser: ArgumentParser,
                                     default: bool = False) -> None:
        """
    ...
    @classmethod
    def add_yolo_classes_argument(cls, parser: ArgumentParser,
        ...
        """
        cls._add_non_boolean_argument(parser, Flag.CLASSES, type=str,
                                      required=required, help='YOLO classes',
                                      nargs="*")

    @classmethod
    def add_yolo_ignore_classes_argument(cls, parser: ArgumentParser,
                                         required: bool = True) -> None:
        """
        ...
        Args:
            ...
            required (bool): Whether the argument is required or not. Defaults to True.
        """
        cls._add_non_boolean_argument(parser, Flag.IGNORE_CLASSES, type=str,
                                      required=required,
                                      help='YOLO ignore classes', nargs="*")

    @classmethod
    def add_yolo_epochs_argument(cls, parser: ArgumentParser,
                                 required: bool = True) -> None:
        """
        ...
        Args:
            ...
            required (bool): Whether the argument is required or not. Defaults to True.
        """
        cls._add_non_boolean_argument(parser, Flag.EPOCHS, type=int,
                                      required=required,
                                      help='YOLO epochs', default=100)

    @classmethod
    def add_yolo_device_argument(cls, parser: ArgumentParser,
                                 required: bool = True) -> None:
        """
        ...
        Args:
            ...
            required (bool): Whether the argument is required or not. Defaults to True.
        """
        cls._add_non_boolean_argument(parser, Flag.DEVICE, type=str,
                                      required=required,
                                      help='YOLO device',
                                      choices=['0', 'cpu', 'cuda'], default='0')

    @classmethod
    def add_yolo_image_size_argument(cls, parser: ArgumentParser,
                                     required: bool = True) -> None:
        """
        ...
        Args:
            ...
            required (bool): Whether the argument is required or not. Defaults to True.
        """
        cls._add_non_boolean_argument(parser, Flag.IMAGE_SIZE, type=int,
                                      required=required,

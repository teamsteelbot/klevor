...
type (
	...
	Service interface {
		...
		SetMotorSpeed(ctx context.Context, speed float64, direction MotorDirection) error
		...
		SetServoAngle(ctx context.Context, angle float64, direction ServoDirection) error
		...
		SetServoToOppositeDirection(ctx context.Context, anglePercentage float64) error

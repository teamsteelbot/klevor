...
from yolo import (YOLO_NUM_AUGMENTATIONS, YOLO_DATASET_LABELED_2C_PROCESSED, \
...
if __name__ == '__main__':
    ...
    if arg_yolo_model == ARGS_YOLO_MODEL_2C:
        augment_dataset(YOLO_DATASET_LABELED_2C_TO_PROCESS, YOLO_DATASET_AUGMENTED_2C_TO_PROCESS,
                        YOLO_NUM_AUGMENTATIONS,
                        YOLO_DATASET_LABELED_2C_PROCESSED)

    else:
        augment_dataset(YOLO_DATASET_LABELED_4C_TO_PROCESS, YOLO_DATASET_AUGMENTED_4C_TO_PROCESS,
                        YOLO_NUM_AUGMENTATIONS,

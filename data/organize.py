...
def split_data(input_to_process_dir: str, output_organized_dir: str, output_processed_dir: str = None, train_ratio=0.7,
    ...
    output_organized_validations_images_dir = os.path.join(output_organized_validations_dir, const.LABELS)
    ...
    output_organized_validations_annotations_dir = os.path.join(output_organized_validations_dir, const.IMAGES)

...
from yolo.args import add_yolo_input_model_argument, add_yolo_version_argument, add_yolo_is_retraining_argument
...
if __name__ == '__main__':
    ...
    # Zip files
    zip_to_train(CWD, YOLO_DIR, organized_dir, yolo_version_dir, yolo_data_dir, yolo_notebooks_dir, yolo_weights_dir, yolo_zip_dir, arg_yolo_input_model, arg_yolo_is_retraining)

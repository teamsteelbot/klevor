...
from yolo.files import get_dataset_model_dir_path, get_yolo_dataset_notes_file_path


# Create a new dataset with the labeled classes removed
def create_dataset_with_removed_classes(input_dir, output_dir, ignore_classes):
    ...
    output_annotations_dir = os.path.join(output_dir, YOLO_DATASET_LABELS)
    output_images_dir = os.path.join(output_dir, YOLO_DATASET_IMAGES)
...
if __name__ == '__main__':
    ...
    input_labeled_dir = get_dataset_model_dir_path(YOLO_DATASET_LABELED, YOLO_DATASET_TO_PROCESS, arg_yolo_input_model)
    output_labeled_dir = get_dataset_model_dir_path(YOLO_DATASET_LABELED, YOLO_DATASET_TO_PROCESS, arg_yolo_output_model)

    # Create the dataset with removed classes
    create_dataset_with_removed_classes(input_labeled_dir, output_labeled_dir, arg_yolo_ignore_classes)
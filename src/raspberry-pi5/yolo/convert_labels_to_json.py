...
from yolo import ARGS_YOLO_MODEL, ARGS_YOLO_VERSION, YOLO_DATASET_LABELED, YOLO_DATASET_TO_PROCESS, YOLO_DATASET_IMAGES, \
...
def convert_yolo_labels_to_json(annotations_dir, images_dir, output_json):
    ...
    for label_file in os.listdir(annotations_dir):
        image_name = label_file.replace(".txt", YOLO_DATASET_IMAGES_EXT)

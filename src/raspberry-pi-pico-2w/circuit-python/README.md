Esta carpeta tiene todo el código hecho en CircuitPython para el desarrollo de Klevor, se recomienda utilizar una Raspberry Pi Pico para poder ejecutar los archivos.

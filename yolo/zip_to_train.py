...
from yolo.constants import YOLO_TO_TRAIN_BASE_FILENAME


# Get the filename of the to train zip file for the given model name
def get_to_train_zip_filename(model_name: str):
    return f'{YOLO_TO_TRAIN_BASE_FILENAME}_{model_name}.zip'
...
def zip_to_train(input_yolo_dir: str, input_yolo_dataset_organized_to_process_dir: str, output_zip_dir: str,
    ...
    output_zip_filename = get_to_train_zip_filename(model_name)

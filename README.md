...
3. **[Componentes](#componentes)**
   ...
   2. [Raspberry Pi Camera Module 3 Wide](#raspberry-pi-camera-module-3)
   3. [Raspberry Pi AI HAT+ (26 TOPS)](#raspberry-pi-ai-hat-26-tops)
   4. [Raspberry Pi Pico 2 WH](#raspberry-pi-pico-2-wh) 
   5. [RPLIDAR C1](#rplidar-c1) 
   6. [Shargeek Storm 2](#shargeek-storm-2) 
   7. [INJORA 180 Motor 48T](#injora-180-motor-48t)
   8. [INJORA MB100 20A mini ESC](#injora-mb100-20a-mini-esc) 
   9. [URGENEX 7.4V Battery](#urgenex-74v-battery) 
   10. [INJORA 7KG 2065 Micro Servo](#injora-7kg-2065-micro-servo) 
...
<h2 id="raspberry-pi-5">Raspberry Pi 5 (16GB RAM)</h2>
...
<h2 id="raspberry-pi-camera-module-3">Raspberry Pi Camera Module 3 Wide</h2>
...
La Raspberry Pi Camera Module 3 Wide es nuestra elección de preferencia, como los demás componentes Raspberry, esta se destaca por ser bastante ligera y portátil, ya que, pues es una cámara bastante pequeña, midiendo apenas 25 mm × 24 mm × 12.4 mm y pesando 4 gramos, sin perder absolutamente ni una pizca de eficiencia, porque puede grabar a 1536 × 864p120, ahora bien, decidimos utilizar la versión Wide por su campo de visión horizontal de 102 grados, porque nos permite tener un rango de visión óptimo para poder detectar todos los obstáculos de la pista.

<h2 id="raspberry-pi-ai-hat-26-tops">Raspberry Pi AI HAT+ (26 TOPS)</h2>
...
<h2 id="raspberry-pi-pico-2-wh">Raspberry Pi Pico 2 WH</h2>
...
<h2 id="rplidar-c1">RPLiDAR C1</h2>
...
El RPLiDAR C1 es un escáner de rango láser de 360 grados, el cual puede detectar superficies que están hasta 12 metros de distancia, su punto ciego es de tan solo 5 centímetros alrededor del mismo, todos estos factores hacen que el RPLiDAR C1 sea una gran opción para poder guíar a Klevor por la pista.
...
<h2 id="shargeek-storm-2">Shargeek Storm 2</h2>
...
<h2 id="injora-180-motor-48t">INJORA 180 Motor 48T</h2>
...
<h2 id="injora-mb100-20a-mini-esc">INJORA MB100 20A mini ESC</h2>
...
El INJORA MB100 20A mini ESC es un controlador de velocidad, normalmente este se usa en conjunto con el INJORA 180 Motor 48T, este permite la conexión entre el INJORA 180 Motor 48T y la Raspberry Pi Pico 2.

<h2 id="urgenex-74v-battery">URGENEX 7.4V Battery</h2>
...
Si bien cualquier batería de 7.4 V funcionaría perfectamente para poder utilizar al INJORA 180 Motor 48T, decidimos utilizar a la URGENEX 7.4v Battery por su capacidad de 3000mAh, la cual nos permite asegurarnos un tiempo prologado de práctica.

<h2 id="injora-7kg-2065-micro-servo">INJORA 7Kg 2065 Micro Servo</h2>
...
1. *RASPBERRY PI 5 16GB, 8GB, 4GB, 2GB – MODELO B. (2025)*. tiendatec. https://www.tiendatec.es/raspberry-pi/gama-raspberry-pi/2149-raspberry-pi-5-16gb-8gb-4gb-2gb-modelo-b.html

2. *Raspberry Pi camera module 3 (standard | wide | NOIR)*. (2025). GeekFactory. https://www.geekfactory.mx/producto/raspberry-pi-camera-module-3/

3. *Kit AI, AI HAT+ Raspberry Pi*. (2025). Kubii. https://www.kubii.com/es/tarjetas-integradas/4343-kit-ai-ai-hat-raspberry-pi-3272496319608.html

4. *Raspberry Pi Pico 2, 2W, 2H, 2WH*. (2025). Kubii. https://www.kubii.com/es/microcontroladores/4377-raspberry-pi-pico-2-2w-2h-2wh-3272496319394.html

5. *Escáner Láser DTOF 360° SLAMTEC RPLIDAR C1*. (2025). RobotShop. https://www.robotshop.com/es/products/escaner-laser-dtof-360-slamtec-rplidar-c1?qd=3ec3808f4c3dd74dab521269d23d2fb2

6. *Shargeek Storm 2, banco de energía para portátil de 100 W, cargador portátil de 25600 mAh, primer banco de energía transparente del mundo con pantalla IPS, Samsung Galaxy, MacBook y más*. (2025). Amazon. https://www.amazon.es/Shargeek-port%C3%A1til-cargador-transparente-pantalla/dp/B09NY8GN76

7. *INJORA Motor Cepillado 180 48T con Piñón de Acero Inoxidable, Conector JST-PH2.0 para Upgrade 1/18 RC Crawler Redcat Ascent-18*. (2025). Amazon. https://www.amazon.es/INJORA-Cepillado-Inoxidable-JST-PH2-0-Ascent-18/dp/B0D97YNMLG?ref_=ast_sto_dp

8. *INJORA MB100-R80 20A Brushed Mini ESC con Motor 180 de 48T para Actualización TRX4M 1/18 RC Crawler*. (2025). Amazon. https://www.amazon.es/INJORA-MB100-Brushed-Actualizaci%C3%B3n-Crawler/dp/B0CXT74XV6?ref_=ast_sto_dp

9. *URGENEX 3000mAh 7.4 V Li-ion Battery with Dean-Style T Plug 2S Rechargeable RC Battery Fit for WLtoys 4WD High Speed RC Cars and Most 1/10, 1/12, 1/16 Scale RC Cars Trucks with 7.4V Battery Charger*. (2025). Amazon. https://www.amazon.com/URGENEX-Bater%C3%ADa-enchufe-recargable-velocidad/dp/B0CYNVSN7W?ref_=ast_sto_dp

10. *INJORA 7KG 2065 Digital Servo Waterproof High Voltage Sub-Micro Shift Servo for TRX4 TRX6 SCX10 III 1/10 RC Crawler Car,1PCS*. (2025). Amazon. https://www.amazon.com/digital-impermeable-voltaje-Sub-Micro-Crawler/dp/B0BLBMVYCW?ref_=ast_sto_dp